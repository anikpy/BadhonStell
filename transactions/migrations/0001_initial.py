    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submissions', to='transactions.customer', verbose_name='Customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='transactions.customersubmission', verbose_name='Submission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_transaction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='edited_versions', to='transactions.transaction', verbose_name='Original Transaction')),
                ('reverses_transaction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reversed_by_transactions', to='transactions.transaction', verbose_name='Reversed Transaction')),
            ],
            options={
